...
copy "!BATPATH!CanAdapterElm\CanAdapterElm.X\dist\def115200\production\*.hex" "!CANADAPTERELMPATH!def115200"
copy "!BATPATH!CanAdapterElm\CanAdapterElm.X\ELM327V15.X\dist\def115200\production\*.hex" "!CANADAPTERELMPATH!def115200"
...
copy "!BATPATH!CanAdapterElm\CanAdapterElm.X\ELM327V15.X\dist\hc04\production\*.hex" "!CANADAPTERELMPATH!hc04"
