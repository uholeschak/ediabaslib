...
p__D30:	call	p__5D4					; entry from: 0D1Ah,0D28h
		...
		clrf	6Dh,BANKED
		bra		p__D04
p__D50:	movff	6Bh,0xF7D				; entry from: 0D42h
		movff	6Ch,SPBRG1
		goto	p_1834
...
p_1072	movff	41h,0xA6				; entry from: 1056h,1066h
		bra		p__E9E
...
p_1B8E	movf	82h,W,BANKED			; entry from: 1B84h
		...
		movwf	83h,BANKED
		bra		p_1B50
p_1B9A	movff	3Dh,0xC4				; entry from: 1B3Eh
		bcf		2Dh,5
		setf	0xC6,BANKED
		movf	3Dh
		bz		p_1C44
...
p_1D02	bcf		3Eh,4					; entry from: 1CC6h
		...
		bra		p_1D18
p_1D08	movff	0xC4,3Dh				; entry from: 1D24h
		call	p_26DE
		movlw	2
		movwf	3Fh
		goto	p__66A
