...
*/
QextSerialPort::QextSerialPort(const QString & name) : QextBaseType(name)
{
}
...
*/
QextSerialPort::QextSerialPort(const QString & name, PortSettings const& settings) : QextBaseType(name, settings)
{
}
