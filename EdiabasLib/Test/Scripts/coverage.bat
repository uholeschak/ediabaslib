...
"%OPEN_COVER%" "-output:results16_5.xml" "-target:!EDIABAS_TEST!" "-filter:!FILTERS!" "-targetargs:!ADD_ARGS! -s \"!ECU_TEST_PATH!\cmd_test2.prg\" -j \"TEST_SHMID###EXIT_EXCEPTION\" -j \"TEST_SHMID###EXIT_EXCEPTION#cmd_test1.prg\""
"%OPEN_COVER%" "-output:results16_6.xml" "-target:!EDIABAS_TEST!" "-filter:!FILTERS!" "-targetargs:!ADD_ARGS! -s \"!ECU_TEST_PATH!\cmd_test2.prg\" -j \"TEST_SHMID###\" -j \"TEST_SHMID###EXIT_EXCEPTION#cmd_test1.prg\""
"%OPEN_COVER%" "-output:results16_7.xml" "-target:!EDIABAS_TEST!" "-filter:!FILTERS!" "-targetargs:!ADD_ARGS! -s \"!ECU_TEST_PATH!\cmd_test2.prg\" -j \"TEST_SHMID###EXIT_EXCEPTION\" -j \"TEST_SHMID####cmd_test1.prg\""
"%OPEN_COVER%" "-output:results16_8.xml" "-target:!EDIABAS_TEST!" "-filter:!FILTERS!" "-targetargs:!ADD_ARGS! -s \"!ECU_TEST_PATH!\cmd_test2.prg\" -j \"TEST_SHMID###BOTH_EXCEPTION\" -j \"TEST_SHMID###BOTH_EXCEPTION#cmd_test1.prg\""
"%OPEN_COVER%" "-output:results16_9.xml" "-target:!EDIABAS_TEST!" "-filter:!FILTERS!" "-targetargs:!ADD_ARGS! -s \"!ECU_TEST_PATH!\cmd_test2.prg\" -j \"INITIALISIERUNG###BOTH_EXCEPTION\" -j \"INITIALISIERUNG####cmd_test1.prg\""
"%OPEN_COVER%" "-output:results16_10.xml" "-target:!EDIABAS_TEST!" "-filter:!FILTERS!" "-targetargs:!ADD_ARGS! -s \"!ECU_TEST_PATH!\cmd_test2.prg\" -j \"TEST_SHMID###INIT_ERROR\""
"%OPEN_COVER%" "-output:results16_11.xml" "-target:!EDIABAS_TEST!" "-filter:!FILTERS!" "-targetargs:!ADD_ARGS! -s \"!ECU_TEST_PATH!\cmd_test2.prg\" -j \"INITIALISIERUNG###INIT_ERROR\""
