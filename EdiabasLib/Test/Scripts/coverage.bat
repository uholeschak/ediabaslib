...
"%OPEN_COVER%" "-output:results6.xml" "-target:!EDIABAS_TEST!" "-filter:!FILTERS!" "-targetargs:!ADD_ARGS! -s \"!ECU_PATH!\tmode.prg\" -j \"LESE_INTERFACE_VERSION\" -j \"LESE_INTERFACE_TYP\" -j \"HOLE_INTERFACE_STATUS\" -j \"HOLE_KEYBYTES\" -j \"LESE_PORT\" -j \"LESE_SPANNUNG_KL15\" -j \"LESE_SPANNUNG_KL30\""
