...
rem When using ICOM use LAN connection and allocate ICOM manually via web interface
...
"%OPEN_COVER%" "-output:results6_2.xml" "-target:!EDIABAS_TEST!" "-filter:!FILTERS!" "-targetargs:!ADD_ARGS! -s \"!ECU_PATH!\tmode.prg\" -j \"LESE_SPANNUNG_KL15\" -j \"LESE_SPANNUNG_KL30\""
"%OPEN_COVER%" "-output:results6_3.xml" "-target:!EDIABAS_TEST!" "-filter:!FILTERS!" "-targetargs:!ADD_ARGS! -s \"!ECU_PATH!\tmode.prg\" -j \"SETZE_PORT#^|010203040506\" -j \"LESE_PORT\" -j \"SETZE_SG_PARAMETER_ALLG#^|0F01000000C20100B0040000140000000A0000000200000088130000\" -j \"SETZE_ANTWORTLAENGE#^|00000000\" -j \"SENDE_TELEGRAMM#^|8212F11A80\""
