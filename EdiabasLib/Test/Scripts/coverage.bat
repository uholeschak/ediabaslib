...
"%OPEN_COVER%" "-output:results13.xml" "-target:!EDIABAS_TEST!" "-filter:!FILTERS!" "-targetargs:!ADD_ARGS! -s \"!ECU_TEST_PATH!\cmd_test1.prg\" -j \"_VERSIONINFO\" -j "_JOBS"
"%OPEN_COVER%" "-output:results14.xml" "-target:!EDIABAS_TEST!" "-filter:!FILTERS!" "-targetargs:!ADD_ARGS! -s \"!ECU_TEST_PATH!\cmd_test2.prg\" -j \"_VERSIONINFO\" -j "_JOBS" -j \"TEST_SHMID###STDARG1\""
