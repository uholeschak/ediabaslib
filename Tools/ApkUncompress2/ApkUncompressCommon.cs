...
public class ApkUncompressCommon
{
    ...
    private static readonly Regex regexCulture = new Regex("^([a-z]{2,3}-[a-z0-9]{2,4}-[a-z]{2}|[a-z]{2,3}-[a-z0-9]{2,4}|[a-z]{2,3})-", RegexOptions.Compiled | RegexOptions.Singleline | RegexOptions.IgnoreCase);
