...
namespace BMW.Rheingold.Psdz
{
    ...
    {
        internal static IPsdzSecurityBackendRequestFailureCto Map(SecurityBackendRequestFailureCtoModel model)
        {
            if (model == null)
            {
                return null;
        ...
        internal static SecurityBackendRequestFailureCtoModel Map(IPsdzSecurityBackendRequestFailureCto psdzObject)
        {
            if (psdzObject == null)
            {
                return null;
