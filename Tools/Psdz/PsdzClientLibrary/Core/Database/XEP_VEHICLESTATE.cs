...
{
    public class XEP_VEHICLESTATE : INotifyPropertyChanged
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            if (!(obj is XEP_VEHICLESTATE xEP_VEHICLESTATE))
            {
                return false;
            }
            if (Id != xEP_VEHICLESTATE.Id)
            {
                return false;
            }
            if (!(TitleId == xEP_VEHICLESTATE.TitleId))
            {
                return false;
            }
            if (string.CompareOrdinal(Title_dede, xEP_VEHICLESTATE.Title_dede) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_engb, xEP_VEHICLESTATE.Title_engb) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_enus, xEP_VEHICLESTATE.Title_enus) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_fr, xEP_VEHICLESTATE.Title_fr) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_th, xEP_VEHICLESTATE.Title_th) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_sv, xEP_VEHICLESTATE.Title_sv) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_it, xEP_VEHICLESTATE.Title_it) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_es, xEP_VEHICLESTATE.Title_es) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_id, xEP_VEHICLESTATE.Title_id) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_ko, xEP_VEHICLESTATE.Title_ko) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_el, xEP_VEHICLESTATE.Title_el) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_tr, xEP_VEHICLESTATE.Title_tr) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_zhcn, xEP_VEHICLESTATE.Title_zhcn) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_ru, xEP_VEHICLESTATE.Title_ru) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_nl, xEP_VEHICLESTATE.Title_nl) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_pt, xEP_VEHICLESTATE.Title_pt) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_zhtw, xEP_VEHICLESTATE.Title_zhtw) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_ja, xEP_VEHICLESTATE.Title_ja) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_cscz, xEP_VEHICLESTATE.Title_cscz) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_plpl, xEP_VEHICLESTATE.Title_plpl) != 0)
            {
                return false;
            }
            return true;
