...
namespace BMW.Rheingold.CoreFramework.DatabaseProvider
{
    public class F_UW_Display : IDtcUmweltDisplay
    {
        ...
        private readonly XEP_ENVCONDSLABELS f_UW_TEXT_EnvCondLabels;

        [XmlIgnore]
        public XEP_ENVCONDSLABELS F_UW_TEXT_EnvCondLabels => f_UW_TEXT_EnvCondLabels;
        ...
        public F_UW_Display(XEP_ENVCONDSLABELS F_UW_TEXT_EnvCondLabels, object current_F_UW_WERT, string current_F_UW_EINH, object first_F_UW_WERT, string first_F_UW_EINH, object second_F_UW_WERT, string second_F_UW_EINH)
        {
        ...
        public F_UW_Display(XEP_ENVCONDSLABELS F_UW_TEXT_EnvCondLabels, object F_UW_WERT, string F_UW_EINH)
        {
            f_UW_TEXT_EnvCondLabels = F_UW_TEXT_EnvCondLabels;
            F_UW_TEXT_vec = null;
