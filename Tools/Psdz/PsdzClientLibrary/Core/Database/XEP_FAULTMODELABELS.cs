...
{
    public class XEP_FAULTMODELABELS : INotifyPropertyChanged, ILocalizedTitle
    {
        ...
        private decimal? erweitertField;
        ...
        public decimal? Erweitert
        {
            get
            {
                return erweitertField;
            }
            set
            {
                if (erweitertField.HasValue)
                {
                    if (!erweitertField.Equals(value))
                    {
                        erweitertField = value;
                        OnPropertyChanged("Erweitert");
                    }
                }
                else
                {
            ...
            get
            {
                ...
                switch (ConfigSettings.CurrentUICulture)
                {
                    ...
                    case "ko-KR":
                        ...
                        break;
                    default:
                        Log.Warning("XEP_FAULTMODELABELS.get_Title", "CurrentUICulture {0} not available - language set to enGB", ConfigSettings.CurrentUICulture);
                        text = Title_engb;
                        break;
                }
        ...
        public override bool Equals(object obj)
        {
            ...
            if (!(obj is XEP_FAULTMODELABELS xEP_FAULTMODELABELS))
            {
                return false;
            }
            if (ID != xEP_FAULTMODELABELS.ID)
            {
                return false;
            }
            if (string.CompareOrdinal(Code, xEP_FAULTMODELABELS.Code) != 0)
            {
                return false;
            }
            if (!(Titleid == xEP_FAULTMODELABELS.Titleid))
            {
                return false;
            }
            if (string.CompareOrdinal(Title_dede, xEP_FAULTMODELABELS.Title_dede) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_engb, xEP_FAULTMODELABELS.Title_engb) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_enus, xEP_FAULTMODELABELS.Title_enus) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_fr, xEP_FAULTMODELABELS.Title_fr) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_th, xEP_FAULTMODELABELS.Title_th) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_sv, xEP_FAULTMODELABELS.Title_sv) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_it, xEP_FAULTMODELABELS.Title_it) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_es, xEP_FAULTMODELABELS.Title_es) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_id, xEP_FAULTMODELABELS.Title_id) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_ko, xEP_FAULTMODELABELS.Title_ko) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_el, xEP_FAULTMODELABELS.Title_el) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_tr, xEP_FAULTMODELABELS.Title_tr) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_zhcn, xEP_FAULTMODELABELS.Title_zhcn) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_ru, xEP_FAULTMODELABELS.Title_ru) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_nl, xEP_FAULTMODELABELS.Title_nl) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_pt, xEP_FAULTMODELABELS.Title_pt) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_zhtw, xEP_FAULTMODELABELS.Title_zhtw) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_ja, xEP_FAULTMODELABELS.Title_ja) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_cscz, xEP_FAULTMODELABELS.Title_cscz) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_plpl, xEP_FAULTMODELABELS.Title_plpl) != 0)
            {
                return false;
            }
            if (!(Relevance == xEP_FAULTMODELABELS.Relevance))
            {
                return false;
            }
            if (!(Erweitert == xEP_FAULTMODELABELS.Erweitert))
            {
                return false;
            }
            return true;
