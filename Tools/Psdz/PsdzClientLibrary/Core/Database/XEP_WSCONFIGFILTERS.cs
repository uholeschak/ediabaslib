...
{
    public class XEP_WSCONFIGFILTERS : INotifyPropertyChanged
    {
        ...
        private string attributeOperatorField;
        ...
        public string AttributeOperator
        {
            get
            {
                return attributeOperatorField;
            }
            set
            {
                if (attributeOperatorField != null)
                {
                    if (!attributeOperatorField.Equals(value))
                    {
                        attributeOperatorField = value;
                        OnPropertyChanged("AttributeOperator");
                    }
                }
                else
                {
        ...
        public string ActualValue
        {
            ...
            set
            {
                ...
                {
                    if (!actualValueField.Equals(value))
                    {
        ...
        public string AttributeName
        {
            ...
            set
            {
                ...
                {
                    if (!attributeNameField.Equals(value))
                    {
        ...
        public string ClassName
        {
            ...
            set
            {
                ...
                {
                    if (!classNameField.Equals(value))
                    {
        ...
        public string Abbreviation
        {
            get
            {
                ...
                {
                    abbreviation = ExtractAbbreviation(Title_dede);
                }
                return abbreviation;
            }
            set
        ...
        public string InfoType
        {
            get
            {
                ...
                {
                    infoType = ExtractInfoType(Title_dede);
                }
                return infoType;
            }
            set
            ...
            get
            {
                ...
                switch (ConfigSettings.CurrentUICulture)
                {
                    ...
                    case "ko-KR":
                        ...
                        break;
                    default:
                        Log.Warning("XEP_WSCONFIGFILTERS.get_Title", "CurrentUICulture {0} not available - language set to enGB", ConfigSettings.CurrentUICulture);
                        text = Title_engb;
                        break;
                }
        ...
        public virtual XEP_WSCONFIGFILTERS Clone()
        {
            return (XEP_WSCONFIGFILTERS)MemberwiseClone();
        }

        private static string ExtractAbbreviation(string titleWithAbbreviation)
        {
            if (string.IsNullOrEmpty(titleWithAbbreviation))
            {
                return titleWithAbbreviation;
            }
            int num = titleWithAbbreviation.LastIndexOf("(", StringComparison.Ordinal);
            if (num == -1)
            {
                return titleWithAbbreviation;
            }
            int num2 = titleWithAbbreviation.LastIndexOf(")", StringComparison.Ordinal);
            if (num2 == -1)
            {
                return titleWithAbbreviation;
            }
            titleWithAbbreviation.LastIndexOf(" ", StringComparison.Ordinal);
            _ = -1;
            if (num2 - num == 1)
            {
                return titleWithAbbreviation;
            }
            return titleWithAbbreviation.Substring(num + 1, num2 - num - 1);
        }

        private static string ExtractInfoType(string titleWithAbbreviation)
        {
            if (string.IsNullOrEmpty(titleWithAbbreviation))
            {
                return titleWithAbbreviation;
            ...
            int num3 = titleWithAbbreviation.LastIndexOf(" ", StringComparison.Ordinal);
            if (num3 == -1)
            {
                num3 = num;
            }
            ...
            return titleWithAbbreviation.Substring(0, num3);
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            if (!(obj is XEP_WSCONFIGFILTERS xEP_WSCONFIGFILTERS))
            {
                return false;
            }
            if (Id != xEP_WSCONFIGFILTERS.Id)
            {
                return false;
            }
            if (!(Nodeclass == xEP_WSCONFIGFILTERS.Nodeclass))
            {
                return false;
            }
            if (string.CompareOrdinal(Enabled, xEP_WSCONFIGFILTERS.Enabled) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Name, xEP_WSCONFIGFILTERS.Name) != 0)
            {
                return false;
            }
            if (!(TitleId == xEP_WSCONFIGFILTERS.TitleId))
            {
                return false;
            }
            if (string.CompareOrdinal(Title_dede, xEP_WSCONFIGFILTERS.Title_dede) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_engb, xEP_WSCONFIGFILTERS.Title_engb) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_enus, xEP_WSCONFIGFILTERS.Title_enus) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_fr, xEP_WSCONFIGFILTERS.Title_fr) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_th, xEP_WSCONFIGFILTERS.Title_th) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_sv, xEP_WSCONFIGFILTERS.Title_sv) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_it, xEP_WSCONFIGFILTERS.Title_it) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_es, xEP_WSCONFIGFILTERS.Title_es) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_id, xEP_WSCONFIGFILTERS.Title_id) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_ko, xEP_WSCONFIGFILTERS.Title_ko) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_el, xEP_WSCONFIGFILTERS.Title_el) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_tr, xEP_WSCONFIGFILTERS.Title_tr) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_zhcn, xEP_WSCONFIGFILTERS.Title_zhcn) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_ru, xEP_WSCONFIGFILTERS.Title_ru) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_nl, xEP_WSCONFIGFILTERS.Title_nl) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_pt, xEP_WSCONFIGFILTERS.Title_pt) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_zhtw, xEP_WSCONFIGFILTERS.Title_zhtw) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_ja, xEP_WSCONFIGFILTERS.Title_ja) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_cscz, xEP_WSCONFIGFILTERS.Title_cscz) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(Title_plpl, xEP_WSCONFIGFILTERS.Title_plpl) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(AttributeOperator, xEP_WSCONFIGFILTERS.AttributeOperator) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(DataType, xEP_WSCONFIGFILTERS.DataType) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(ActualValue, xEP_WSCONFIGFILTERS.ActualValue) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(DefaultValue, xEP_WSCONFIGFILTERS.DefaultValue) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(AttributeName, xEP_WSCONFIGFILTERS.AttributeName) != 0)
            {
                return false;
            }
            if (string.CompareOrdinal(ClassName, xEP_WSCONFIGFILTERS.ClassName) != 0)
            {
                return false;
            }
            return true;
