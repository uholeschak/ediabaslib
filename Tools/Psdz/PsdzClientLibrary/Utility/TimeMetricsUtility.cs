...
namespace PsdzClient.Utility
{
    public class TimeMetricsUtility
    {
        ...
        public static bool HasMetrics => currentMetrics != null;
        ...
        public TimeSpan GetVehicleIdentTestDuration(TimeMetricsStage stage)
        {
            //[-]return metrics.Find((TimeMetrics x) => x.Stage == stage)?.Watch.Elapsed ?? TimeSpan.Zero;
            //[+]return TimeSpan.Zero;
            return TimeSpan.Zero;
        }
    }
