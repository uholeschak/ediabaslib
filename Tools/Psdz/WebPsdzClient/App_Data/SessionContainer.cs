    ...
    public class SessionContainer : IDisposable
    {
        ...
        public SessionContainer(string sessionId, string dealerId)
        {
            ...
            try
            {
                ...
                bool connected = Task.Run(() => serverStarter.ConnectPipeClient(Global.RpcServer, Global.RpcServiceName, ProcessWindowStyle.Hidden, RpcClient, Cts)).GetAwaiter().GetResult();
        ...
        private bool SelectOption(PsdzClient.Programming.ProgrammingJobs.OptionsItem optionItem, bool select)
        {
            ...
            if (modified)
            {
                ...
                ProgrammingJobs.UpdateTargetFa();
            }
