...
namespace CarSimulator
{
    public class CommThread
    {
        ...
        private class EcuAddressEntry
        {
            public EcuAddressEntry(uint group, uint tp20Ecu, uint tp20Tester, uint isoTpEcu, uint isoTpTester)
            {
                Group = group;
                Tp20Ecu = tp20Ecu;
...
#pragma warning restore 414
        ...
        private const int Tp20T3 =
                                    ...
                                    0;
#endif
        private EcuAddressEntry[] EcuAddressArray =
        {
