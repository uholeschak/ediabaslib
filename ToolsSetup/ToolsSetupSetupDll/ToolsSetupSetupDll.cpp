...
const std::wstring UNLOAD_FILE_NAME_BASE = L"Ulrich Holeschak ToolsSetup";
const std::wstring DESTINATION_PATH = L"\\UM\\Program Files\\ToolsSetup\\";
...
const std::wstring INSTALL_COMPLETE_CAPTION = L"ToolsSetup";
const std::wstring INSTALL_COMPLETE_TEXT = L"ToolsSetup application was successfully installed!";
