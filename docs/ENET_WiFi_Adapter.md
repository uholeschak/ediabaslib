...
* Install [.NET framework 4.8](https://dotnet.microsoft.com/en-us/download/dotnet-framework/net48) or higher and [VS2015 C++ runtime](https://aka.ms/vs/17/release/vc_redist.x86.exe) (recommended, but not required)
