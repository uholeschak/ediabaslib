...
There is an alternative commercial [Unichip ENET WiFi adapter](http://m.unichip-tec.com/bmw_enet_wifi_wireless_esys.html) available. Another alternative is the [modBMW Wifi ENET adapter](https://modbmw.com/shop/wifi-enet/) which also uses the [A5-V11 3G/4G Router](https://wiki.openwrt.org/toh/unbranded/a5-v11).
