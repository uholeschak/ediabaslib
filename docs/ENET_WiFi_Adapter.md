...
There is an alternative commercial [Unichip ENET WiFi adapter](http://m.unichip-tec.com/bmw_enet_wifi_wireless_esys.html) available. Another alternative is the [modBMW Wifi ENET adapter](https://modbmw.com/shop/wifi-enet/) which uses OpenWrt.  
